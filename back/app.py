...
def load_user(user_id):
    """Loads a user using direct SQL query."""
    user_data = fetch_data("SELECT * FROM Users WHERE user_id = %s", (user_id,), fetch_one=True)
    return User(*user_data) if user_data else None  # Convert row data to User object
